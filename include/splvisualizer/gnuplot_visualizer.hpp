        ...
        public:
            ...
            ) override
            {
                ...
                for (size_t i = 0; i < num_dims; ++i)
                {
                    ...
                    for (const std::pair<double, spl::VectorRepresentation>& trajectory_point : planned_trajectory)
                    {
                        fprintf(
                            this->gnuplot_pipe,
                            "%f %f\n",
        ...
        public:
            ...
            ) override
            {
                ...
                if (num_dims == 2)
                {
                    ...
                    for (const spl::VectorRepresentation& joint_position : timed_joint_positions.second)
                    {
